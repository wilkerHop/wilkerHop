import{f as l}from"./github-api-BtgFlwTg.js";import{b as a}from"./utils-ljjxNF0z.js";async function i(){try{const e=document.getElementById("articles-grid");if(!e){console.error("Articles grid element not found");return}e.innerHTML='<div class="col-span-full text-center text-2xl font-black uppercase">Loading articles...</div>';const{articles:o}=await l(),r=o;if(r.length===0){e.innerHTML=`
      ...
      `;return}e.innerHTML=r.map(t=>a(t)).filter(t=>t!=="").join("");const n=document.getElementById("demos-dropdown");n&&(r.length>0?n.innerHTML=r.map(t=>`
          <a href="${t.homepage}" 
