...
1. 🥇 **TypeScript** with **4 hrs 25 mins** of pleasure.
2. 🥈 **JSON** with **36 mins** of work.
3. 🥉 **YAML** with **5 mins** of playing.
4. 🏅 **Markdown** with **5 mins** of extreme thinking.
5. 🎖️ **JavaScript** with **1 min** of worrying bugs would appear.

And more **27 mins** of 😁🖱💻🔌 (diverse file extensions).
